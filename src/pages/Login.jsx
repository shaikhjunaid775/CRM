import { ChevronLeft, RotateCcw, ChevronDown, Globe } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="max-w-xl mx-auto bg-white rounded-lg p-8 ">
          ...
          {/* Sign In Form */}
          <h1 className="text-3xl font-bold text-center mb-6">{t.signIn}</h1>

          <div className="text-center mb-6 flex flex-col justify-center items-center gap-3 sm:flex-row">
            <span className="text-gray-600">{t.notRegistered}?</span>
            <Link
              to="/registration"
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="relative z-0">
                <input
                  ...
                  className="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b border-gray-300 appearance-none  focus:outline-none focus:ring-0  peer"
                  placeholder=" "
                />
                <label
                  htmlFor="password"
            ...
            <div className="flex flex-col gap-3 sm:flex-row items-center justify-between mb-10">
              ...
              <div className="flex gap-2 items-center">
                <RotateCcw className="stroke-light-blue rotate-70 w-5" />
                <Link
                  to="/forgotpassword"
                  className="border-light-blue border-b "
                >
                  {t.passwordRecovery}
                </Link>
              </div>
